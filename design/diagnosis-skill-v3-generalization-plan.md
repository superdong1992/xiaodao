...
- 状态：已完成（2026-08-04）。
- 实际版本：GenerationSpec v2、generator/生成 Skill `3.0.4`、manifest schema `2`、DIAGNOSE output contract `2.0.3`、S00 contract revision `v1-contract-r4`。
...
- `GenerationSpec.schema_version` 升为 `2`，生成器升为 `3.0.4`，生成 Skill 升为 `3.0.4`。
...
- 版本矩阵：`GenerationSpec v2`、generator `3.0.4`、manifest schema `2`、生成 Skill `3.0.4`、DIAGNOSE output contract `2.0.3`、S00 contract revision `v1-contract-r4`。
