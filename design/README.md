...
- 局域网部署 registration 生成合同：`.claude/skills/wiki-to-logparse-diagnosis-skill/`；它生成 `registration-template.json` 与闭合 Methods package，供客户端经 MCP 路由到当前 Server 两阶段链路
