...
状态：Problem Locator 2.0 与 Test Flow 终态设计
...
State、Job 与权威 Outcome 使用 schema v3。Agent 只生成 draft；服务端重新验证原始证据并生成权威 Outcome、公开 JSON/ZIP 或不可定论结果。Diagnosis Skill generator 与 manifest 的当前版本表见根 README。
