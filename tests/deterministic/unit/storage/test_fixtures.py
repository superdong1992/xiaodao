...
def test_valid_empty_v10_state_fixture_is_accepted() -> None:
    payload = parse_canonical_json_bytes(_fixture_bytes("state/valid-empty-v10.json"))
    ...
    assert state.contract_revision == CONTRACT_REVISION == "v10-contract-r1"
