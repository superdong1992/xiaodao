...
@pytest.mark.skipif(
    ...
    reason="requires an explicitly configured native Windows runner",
)
def test_native_windows_startup_gate(tmp_path: Path) -> None:
    _run_native_startup_gate("Windows", tmp_path)
