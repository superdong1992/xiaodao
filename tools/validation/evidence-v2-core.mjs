...
export const EVIDENCE_V2_CORE_SELECTORS = Object.freeze([
  ...
  "tests/deterministic/unit/runtime/test_diagnosis_runtime.py::test_methods_v1_specialist_publishes_json_and_durable_archive_plan",
  ...
  "tests/deterministic/contracts/test_user_result_v2.py::test_completed_candidate_server_final_requires_json_and_allows_deferred_archive",
