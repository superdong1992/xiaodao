...
case "${1:-}" in
  ...
  target)
    python -m pytest -q \
      ...
      tests/deterministic/unit/integrations/test_generator_v3.py \
      tests/deterministic/unit/integrations/test_result_archive.py \
      tests/deterministic/unit/integrations/test_skill_contract.py \
      tests/deterministic/unit/integrations/test_logparse_outputs.py \
      ...
      tests/deterministic/unit/interfaces/test_mcp_server.py \
      tests/deterministic/unit/runtime/test_catalog.py \
