...

{
  ...
  printf 'pytest=python -m pytest -q tests/platform/distribution/test_installed_distribution_gate.py::test_clean_installed_distribution_import_cli_and_server_gate --basetemp=/tmp/pytest-attempt41-installed --junitxml=/evidence/03-installed-distribution.xml\n'
