...
_AUDIT_FILENAMES = frozenset(
    {
        ...
        "methods-reviewer-repair-prompt.txt",
        "methods-reviewer-repair.rejected.json",
        "methods-specialist-primary.rejected.json",
        "methods-specialist-prompt.txt",
        "methods-specialist-repair-prompt.txt",
        "methods-specialist-repair.rejected.json",
