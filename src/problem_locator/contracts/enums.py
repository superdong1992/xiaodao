...
class MethodsValidationReasonCode(StrEnum):
    EVIDENCE_MARKER_NOT_INDEXED = "METHOD_EVIDENCE_MARKER_NOT_INDEXED"
    CONFIRMED_EVIDENCE_MISSING = "METHOD_CONFIRMED_EVIDENCE_MISSING"
    CONFIRMED_MARKER_SCAN_MISS = "METHOD_CONFIRMED_MARKER_SCAN_MISS"
    EVIDENCE_SOURCE_CHANGED = "METHOD_EVIDENCE_SOURCE_CHANGED"
...
class TriggerType(StrEnum):
    ...
    RESTART_GENERIC_DIAGNOSIS = "RESTART_GENERIC_DIAGNOSIS"
